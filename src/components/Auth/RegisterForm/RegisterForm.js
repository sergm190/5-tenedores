    ...
    onSubmit: async (formValue)=>{
      ...
      try { 
        ...
        Toast.show({
          type:"error",
          position: 'bottom',
          text1: "Error al registrar, intente de nuevo"
        })
        // console.log(error);
      }
    }
  ...
  return (
    <View style={styles.content}>
     ...
     <Input placeholder='Contraseña' containerStyle={styles.input} secureTextEntry={showPassword ? false : true}
        ...
        iconStyle={styles.icon} onPress={showHiddenPassword}/>
      } 
        onChangeText={text => formik.setFieldValue("password", text)} 
        errorMessage={formik.errors.password}
      />
        
     <Input placeholder='Repetir contraseña' containerStyle={styles.input} secureTextEntry={showPassword ? false : true}
